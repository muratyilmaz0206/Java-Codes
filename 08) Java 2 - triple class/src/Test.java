...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.out.println(p0.getName()+"'s" + " father name is "
		+ p0.father.getName()
		+ " and mother is "
		+ p0.mother.getName()); // syso + control + space
		
		
System.out.println(p0.getName() + "'s gender is " + p0.getGender());
		
		Employee e = new Employee("Michael");
		e.salary = 2500;
		e.mother = p2;
		e.age = 19;
		e.gender = People.MALE;
		
		System.out.println(e.getName()+"'s salary is " + e.salary 
				+ " and gender is " + e.getGender());
